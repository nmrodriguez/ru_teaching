...
<source src="libs/media/infantil1.mp4" type="video/mp4">
</video>
...
<video width="500" height="500">
<source src="libs/media/infantil2.mp4" type="video/mp4">
</video>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/CejhQC9hUO8" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
- se refiere al grado de conocimiento de la estructura de la lengua

  - la fonología, la morfología, la sintaxis, la semántica, y la pragmática
...
- se refiere a la habilidad de usar la lengua en contextos discursos diferentes, más allá de si lo que dice el hablante está gramaticalmente correcto o no

- Hymes (1966)
]

---
# Definimos el bilingüismo 

Solo es bilingüe una persona que...

1. habla dos lenguas perfectamente, a nivel de hablante nativo

2. se crió en una familia donde se hablaba más de una lengua

3. nació en un país donde se hablan dos o más lenguas

4. cuando era niño/a/e, hablaba una lengua pero de adulto habla otra

5. habla dos lenguas desde la inflancia

6. adquirió la lengua materna y luego aprendió otra lengua

7. tiene un conocimento parcil de dos o más lenguas

8. usa dos lenguas en la vida cotidiana 

9. usa una lengua pero tiene conocimiento de otras dos lenguas

10. entiende y habla una lengua pero comprende una lengua segunda

---
# Ahora consideramos quién es monolingue

Es monolingüe una persona que...

1. conoce y habla una sola lengua en la vida cotidiana 

2. entiende y habla una lengua bien pero comprende otras dos

3. nació en un país donde solo se habla una lengua 

4. habla, lee y escribe varias lenguas pero en la vida cotidiana solo usa una lengua 
...
## Factores que definen y caracterizan a los bilingües
...
- El contexto de adquisición 

--

- El grade de uso de las lenguas 

--

- El nivel de conocimiento de las dos lenguas 
...
![mode](libs/img/mode.png)

---
background-image: url("libs/img/tweet3.png")
background-size: contain
...
# "El bilingüismo, pese a ser un fenómeno muy complejo, es generalmente beneficioso para los individuos y para la sociedad, aunque no siempre sea percibido y apreciado de esta forma"

---
background-image: url("libs/img/tweet2.jpg")
background-size: contain
...
# "El bilingüismo es también un fenómeno político y social que depende de la coexistencia y el uso de dos lenguas en la misma comunidad. Mientras que en algunos contextos políticos el bilingüismo tiene connotaciones muy positivas y es un símbolo de estatus internacional, en otros contextos ser bilingüe tiene connotaciones muy negativas y es producto de estigmatización social."

---
background-image: url("libs/img/tweet1.jpg")
background-size: contain

---
class: center, middle

# ¿De dónde surgen las connotaciones negativas del bilingüismo?
...
---
background-image: url("libs/img/end.png")
background-size: contain
